...
export default function Profile() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            login(updatedUser, token); // cập nhật lại store + localStorage
        ...
        <div className="max-w-2xl mx-auto">
            ...
            {!isStaffOrAdmin && (
                <div className="flex gap-3 mb-6">
                    <Link to="/profile" className="px-4 py-2 rounded-md bg-green-600 text-white text-sm">
                        Thông tin cá nhân
                    </Link>
                    <Link to="/orders" className="px-4 py-2 rounded-md bg-white border text-sm hover:bg-gray-50 flex items-center gap-1">
